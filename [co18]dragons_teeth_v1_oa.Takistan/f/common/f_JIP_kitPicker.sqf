...
KitPickInit =
{
    ...
    _idx = COMBO lbAdd "Rifleman (RPG)"; COMBO lbSetData [_idx, "rrpg"];
    COMBO lbAdd "----";

    _idx = COMBO lbAdd "Medium MG Gunner"; COMBO lbSetData [_idx, "mmgg"];
    _idx = COMBO lbAdd "Medium MG Asst. Gunner"; COMBO lbSetData [_idx, "mmgag"];
    COMBO lbAdd "----";

    _idx = COMBO lbAdd "Medium AT Gunner"; COMBO lbSetData [_idx, "matg"];
    _idx = COMBO lbAdd "Medium AT Asst. Gunner"; COMBO lbSetData [_idx, "matag"];
    COMBO lbAdd "----";
